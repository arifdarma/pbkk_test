        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sukses di check out dan mohon melanjutkan 
                    transaksi dengan mentransferkan ke <strong>Bank ABC dengan nomor rekening 43132413421</strong>
                    sebanyak <strong>Rp. {{number_format($pesanan->jumlah_harga + $pesanan->kode)}}</strong></h5>
                </div>
            </div>
            <div class="card mt-2">
                <h3 class="col-md-12 mt-3"><i class="fa fa-shopping-cart"></i> Detail Pemesanan</h3>
                @if(!@empty($pesanan))
                <p align="center">Tanggal Pesan : {{$pesanan->tanggal}}</p>
